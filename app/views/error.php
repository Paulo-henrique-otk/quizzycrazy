...
<head>
    ...
    <title>QuizzyCrazy : Erro <?=$errorNumber?></title>
</head>
<body>
<main>
    <strong>Erro <?=$errorNumber?></strong>
    <p>O Erro Dado foi <?=$errorNumber?>,Pesquise Nos Números de Requisições HTTP Para Saber Qual Significado do Erro.</p>
